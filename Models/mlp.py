...
def fc(input_shape, num_classes, pretrained=False, L=6, N=100, nonlinearity=nn.ReLU()):
...
def conv(input_shape, num_classes, pretrained=False, L=3, N=32, nonlinearity=nn.ReLU()): 
