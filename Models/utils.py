...
def vision_transformer(model_name):
    ...
    params_dict = {
        'ViT-Ti': (224, 8, 192, 1024, 3, 12, 1000, 0.0, 0.1, None),
        'ViT-S_32': (224, 32, 384, 2048, 6, 12, 1000, 0.0, 0.1, None),
        'ViT-S_16': (224, 16, 384, 2048, 6, 12, 1000, 0.0, 0.1, None),
        'ViT-S_14': (224, 14, 384, 2048, 6, 12, 1000, 0.0, 0.1, None),
        'ViT-S_8': (224, 8, 384, 2048, 6, 12, 1000, 0.0, 0.1, None),
